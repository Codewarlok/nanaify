    ...
    return (
        <div className="flex items-center gap-2 relative overflow-hidden">
            ...
            <div className="flex flex-col ml-2">
                ...
                <span className="text-xs opacity-70">{artists?.join(', ')}</span>
            </div>
        </div>
    )
}
    ...
    return (
        <div className="flex gap-x-3 text-xs pt-2">
            <span className="opacity-50 w-12 text-right">
                {currentTime ? formatTime(currentTime) : null}</span>
            <Slider 
            defaultValue={[0]}
            value={[currentTime]}
...
const VolumeControl = () => {
    ...
    const isVolumeMutted = volume < 0.1
    ...
    return (
        <div className="flex justify-center gap-x-2">
            <button className="opacity-70 hover:opacity-100 transition" onClick={handleClickVolume}>
                {isVolumeMutted ? <VolumeSilence /> : <Volume />}
            </button>
...
export function Player() {
    ...
    return (
        <div>
            ...
            <div className="w-[200px] grid place-content-center">
                <VolumeControl />
            </div>
        </div>
        </div>
